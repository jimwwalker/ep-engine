...
public:
    ...
    virtual ENGINE_ERROR_CODE deletion(uint32_t opaque, const ItemKey& key, uint64_t cas,
                                       uint16_t vbucket, uint64_t bySeqno,
                                       uint64_t revSeqno, const void* meta,
                                       uint16_t nmeta);

    virtual ENGINE_ERROR_CODE expiration(uint32_t opaque, const ItemKey& key, uint64_t cas,
                                         uint16_t vbucket, uint64_t bySeqno,
                                         uint64_t revSeqno, const void* meta,
                                         uint16_t nmeta);

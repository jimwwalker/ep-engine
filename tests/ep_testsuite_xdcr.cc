...
static enum test_result test_cas_regeneration(ENGINE_HANDLE *h,
    ...
    set_with_meta(h, h1, "key", 3, NULL, 0, 0, &itemMeta, 0,
                  REGENERATE_CAS|SKIP_CONFLICT_RESOLUTION_FLAG|FORCE_ACCEPT_WITH_META_OPS);
...
#pragma pack()

    {
        ...
        set_with_meta(h, h1, "key1", 4, NULL, 0, 0, &itemMeta, 0,
                      FORCE_ACCEPT_WITH_META_OPS, PROTOCOL_BINARY_RAW_BYTES,
...

    {
        ...
        // Set the key with a low CAS value and real nmeta
        set_with_meta(h, h1, "key2", 4, NULL, 0, 0, &itemMeta, 0,
                      FORCE_ACCEPT_WITH_META_OPS, PROTOCOL_BINARY_RAW_BYTES,
                      nullptr, validMetaVector);
        checkeq(PROTOCOL_BINARY_RESPONSE_SUCCESS, last_status.load(),
                "Expected success");
...

    {
        ...
        // Set the key with a low CAS value and real nmeta
        set_with_meta(h, h1, "key3", 4, NULL, 0, 0, &itemMeta, 0,
                      FORCE_ACCEPT_WITH_META_OPS, PROTOCOL_BINARY_RAW_BYTES,
                      nullptr, validMetaVector);
        checkeq(PROTOCOL_BINARY_RESPONSE_SUCCESS, last_status.load(),
                "Expected success");
